...
python-metallum is a community-driven project. Contribution is welcome, encouraged, and appreciated.
...
python-metallum uses the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/)
